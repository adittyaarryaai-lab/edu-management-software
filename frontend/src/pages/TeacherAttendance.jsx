            ...
            <div className="flex justify-between items-center px-2">
                <div>
                    ...
                    <select 
                        ...
                        className="bg-transparent font-black text-lg outline-none appearance-none cursor-pointer text-white italic uppercase"
                    >
                        <option value="10-A" className="bg-void">10-A</option>
                        <option value="12-C" className="bg-void">12-C</option>
                    </select>
                </div>
      ...
      <div className="px-5 -mt-10 space-y-4 relative z-20">
        ...
        {students.map((student) => (
            <div key={student.id} className="bg-white/5 backdrop-blur-xl p-5 rounded-[2.5rem] flex justify-between items-center shadow-2xl border border-white/5 group hover:border-neon/30 transition-all italic">
                ...
                <button 
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-2xl font-black text-[9px] uppercase transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] ${
        ...
        <div className="pt-10 pb-20 w-full px-4 z-30 italic">
            <button 
                ...
                className={`w-full py-5 rounded-[2rem] font-black shadow-[0_0_30px_rgba(61,242,224,0.2)] flex items-center justify-center gap-3 active:scale-95 transition-all uppercase text-[11px] tracking-[0.3em] ${
                    isSaving ? 'bg-slate-800 text-white/20' : 'bg-neon text-void shadow-[0_0_20px_rgba(61,242,224,0.4)]'
                }`}
            >
