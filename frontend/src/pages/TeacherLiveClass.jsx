...
import { ArrowLeft, Video, Construction, ShieldAlert, Zap } from 'lucide-react';
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-md">
                ...
                <div className="mb-10 relative">
                    ...
                    <div className="absolute -top-2 -right-2 bg-white p-2 rounded-full shadow-lg border border-blue-50">
                        <Video size={24} className="text-amber-400 animate-pulse" />
                    </div>
                </div>

                {/* Text Section */}
                <h1 className="text-4xl font-black italic tracking-tight text-slate-800 leading-tight mb-4 capitalize">
                    Live session node <br /> <span className="text-[#42A5F5]">under development</span>
                </h1>
                ...
                <p className="text-[16px] text-slate-400 font-bold italic max-w-[320px] leading-relaxed capitalize">
                    We are calibrating the neural broadcast matrix for high-fidelity live classes. <br />
                    <span className="text-[#42A5F5] block mt-2 italic">Syncing meeting manager...</span>
                </p>
