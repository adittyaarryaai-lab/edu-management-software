...
class _StudentCheckoutState extends ConsumerState<StudentCheckout> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color bgIconColor = isDarkMode
        ? Colors.white.withValues(alpha: 0.02)
        : Colors.black.withValues(alpha: 0.04);

    // Billing card ko dark mode mein thoda alag shade dene ke liye
    final Color billingCardColor =
        isDarkMode ? const Color(0xFF020617) : const Color(0xFF1E293B);
      ...
      child: AnimatedContainer(
        ...
        child: Scaffold(
          backgroundColor: Colors
              .transparent, // Transparent so AnimatedContainer shows through
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                              Positioned(
                                ...
                                child: Icon(Icons.person,
                                    size: 100, color: bgIconColor),
                              ),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  const Text("STUDENT IDENTIFICATION",
                                      style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.bold,
                        ...
                        GestureDetector(
                          onTap: () => context.push(
                              '/student/payment-methods'), // Push to exact route
                          child: Container(
                            width: double.infinity,
