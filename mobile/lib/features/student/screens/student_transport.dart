...
class _StudentTransportState extends ConsumerState<StudentTransport> {
  ...
  // React code mein ye array tha jo abhi UI me map nahi hua, par exact conversion ke liye rakha hai
                          ...
                          children: [
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: const [
                                  TextSpan(text: "Our transport tracking neural network is being synchronized.\n"),
